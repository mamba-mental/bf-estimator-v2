...
def project_body_composition_changes(
    ...
    for week in range(1, max_weeks + 1):
        ...
        remaining_fat_to_lose = max(fat_mass - (goal_weight * goal_bf / 100) / (1 - goal_bf / 100), 0)
        ...
        weekly_fat_loss = calculate_weekly_rate_of_fat_loss(
            weight, bf_percent, tdee, daily_calories, diet_type, activity_level, exercise_type, ped_use, is_bodybuilder
        )
        weekly_muscle_gain = calculate_weekly_muscle_gain(
            weight, bf_percent, protein_intake, diet_type, resistance_training, experience_level, exercise_type, ped_use, is_bodybuilder, sleep_quality
        )
...
if __name__ == "__main__":
    ...
    fat_loss = calculate_weekly_rate_of_fat_loss(254, 20, 3000, 1500, "keto", "active", "resistance", True, True)
    print(f"Fat Loss: {fat_loss:.2f} lbs")
    muscle_gain = calculate_weekly_muscle_gain(254, 20, 200, "keto", True, "advanced", "resistance", True, True, "good")
    print(f"Muscle Gain: {muscle_gain:.2f} lbs")