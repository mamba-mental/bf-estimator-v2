...
class BodyFatEstimatorApp:
    ...
    def setup_reports_history(self):
        ...
        self.reports_list_frame.grid_columnconfigure((0, 1, 2, 3), weight=1)
    ...
    def load_report_history(self):
        ...
        if not rows:
            ...
            no_data_label.grid(row=1, column=0, columnspan=4, padx=10, pady=20)
            return
        ...
        for i, (id, name, date, json_path, md_path, pdf_path) in enumerate(rows):
            ...
            if pdf_path and os.path.exists(pdf_path):
                ...
                pdf_btn.grid(row=row_num, column=2, padx=5, pady=2)
            else:
                ctk.CTkLabel(self.reports_list_frame, text="N/A").grid(row=row_num, column=2, padx=5, pady=2, sticky="w")
            ...
            if md_path and os.path.exists(md_path):
                ...
                md_btn.grid(row=row_num, column=3, padx=5, pady=2)
            else:
                ctk.CTkLabel(self.reports_list_frame, text="N/A").grid(row=row_num, column=3, padx=5, pady=2, sticky="w")
    ...
    def setup_results_view(self):
        ...
        # Corrected indentation for the label and grid call
